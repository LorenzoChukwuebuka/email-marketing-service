...
import { TicketFile } from '../../../../store/userstore/support.store';
import * as yup from 'yup';
import CustomTooltip from "../../../../components/tooltipComponent";
...
const TicketDetails: React.FC = () => {
    ...
    const { getTicketDetails, supportTicketData, replyTicket, closeTicket } = useSupportStore()
    ...
    const renderAttachments = (files: TicketFile[]) => {
        ...
        let baseUrl = import.meta.env.VITE_BASE_API_URL as string;
    ...
    return (
        <>
            ...
            <HelmetProvider>
                <Helmet title={`Ticket  #${(supportTicketData as Ticket).ticket_number}`} />
                        ...
                        <div className="w-full lg:w-3/4 -mt-5 p-6">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow mb-10">
                                ...
                                <div className="flex justify-between mb-6">
                                    ...
                                    <CustomTooltip text="You can reopen a ticket by replying to the ticket" />
                                </div>

                                {(supportTicketData as Ticket)?.messages &&
                                    (supportTicketData as Ticket)?.messages.map((message, index) => (

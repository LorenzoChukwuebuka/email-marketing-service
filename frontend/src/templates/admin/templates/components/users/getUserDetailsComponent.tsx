        ...
        <div className="container mx-auto p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-blue-500 text-white p-4 rounded-lg shadow">
                    ...
                    <a href="#" className="text-xs mt-2 bg-white text-blue-500 px-2 py-1 rounded hover:bg-blue-100 transition-colors duration-200 text-center">
                        View Sent Campaigns
                    </a>
                </div>
            ...
            <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-2">
                    ...
                    {/* <p><span className="font-medium">Balance:</span> $125,000.00 USD</p> */}
                </div>
            </div>
        </div>
    );

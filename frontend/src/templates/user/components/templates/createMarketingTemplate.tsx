...
const CreateMarketingTemplate: React.FC<Props> = ({ isOpen, onClose }) => {
    ...
    return <>
        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Create Marketing Template">
            <>

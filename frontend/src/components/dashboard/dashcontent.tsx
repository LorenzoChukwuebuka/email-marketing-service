                    ...
                    <div className="dropdown dropdown-end relative">
                        ...
                        {isNotificationDropdownOpen && (
                            <div className="dropdown-content menu bg-white rounded-box z-[50] mt-4 w-80 p-2 shadow absolute right-0">
                                ...
                                {hasNotifications && (
                                    <Link to="/app/notifications" className="text-blue-500 text-sm font-semibold p-3 block text-center hover:bg-gray-100 rounded-b-lg">
                                        View all activity
                                    </Link>
                                )}
                            </div>
                                ...
                                <li>
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-blue-500">
                                            ...
                                            <Link to="/app/settings/account-management"> My Profile</Link>
                                        </span>
                                        <span className="text-black">
                                            <i className="bi bi-gear-wide-connected"></i>
                                            <Link to="/app/settings/api"> API & SMTP</Link>
                                        </span>

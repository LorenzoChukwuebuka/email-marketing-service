...
import CreateMarketingTemplateComponent from "../../components/marketing/createMarketingComponent";
...
const CreateMarketingTemplateDashBoard: React.FC = () => {
    ...
    return (
        <div className="p-6 max-w-full">
            ...
            <CreateMarketingTemplateComponent isOpen={isModalOpen} onClose={handleCloseModal} editorType={

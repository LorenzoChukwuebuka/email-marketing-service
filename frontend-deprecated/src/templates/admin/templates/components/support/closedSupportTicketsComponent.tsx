...
const ClosedSupportTicketComponentTable: React.FC = () => {
    const { supportData, getAllClosedTickets, paginationInfo } = useAdminSupportStore()
    const handleSearch = (query: string) => { }

    const handlePageChange = () => {
        getAllClosedTickets(paginationInfo.page_size)
    }
    ...
    return <>
        ...
        <div className="overflow-x-auto mt-4">
            ...
            <Pagination paginationInfo={paginationInfo} handlePageChange={handlePageChange} item={"Closed Tickets"} />
        </div>

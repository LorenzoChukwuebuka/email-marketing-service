...
type Config struct {
	...
	GOOGLE_CLIENT_LOGIN_REDIRECT_URL_PROD  string `env:"GOOGLE_CLIENT_LOGIN_REDIRECT_URL_PROD"`
	GOOGLE_CLIENT_SIGNUP_REDIRECT_URL_PROD string `env:"GOOGLE_CLIENT_SIGNUP_REDIRECT_URL_PROD"`
}
...
var LoadEnv = func() *Config {
	...
	config := &Config{
		...
		GOOGLE_CLIENT_LOGIN_REDIRECT_URL_PROD:  os.Getenv("GOOGLE_CLIENT_LOGIN_REDIRECT_URL_PROD"),
		GOOGLE_CLIENT_SIGNUP_REDIRECT_URL_PROD: os.Getenv("GOOGLE_CLIENT_SIGNUP_REDIRECT_URL_PROD"),

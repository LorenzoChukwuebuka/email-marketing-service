                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="/home/privacy" className="hover:text-gray-300 transition duration-300">Privacy Policy</a></li>
                                <li><a href="/home/tos" className="hover:text-gray-300 transition duration-300">Terms of Service </a> </li>
                                <li><a href="/home/gdpr" className="hover:text-gray-300 transition duration-300">GDPR</a></li>
                            </ul>
                        </div>
                    </div>
